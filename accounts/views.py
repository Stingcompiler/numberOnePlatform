...
???????? ?????????? ???????????????? (Auth Endpoints):
  ...
  POST /api/auth/refresh/     ??? ?????????? ?????? Access Token ???? Refresh Cookie
  GET  /api/auth/me/          ??? ???????????? ???????????????? ????????????
...
class TokenRefreshCookieView(APIView):
    ...
    ?????????????? ???????????? Axios Interceptor ???? React ?????? ???????????? ???????????? ?????? Access Token.
    """
...
class AdminStudentRequestDetailView(generics.RetrieveUpdateDestroyAPIView):
    """GET / PATCH / DELETE /api/student-requests/<id>/ ??? ?????????? ?????? ????????"""
    permission_classes = [IsAdminOrManager]
...
# ???????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????
# 10. ?????????? ?????????????? ?????????????? (NewStudentRegistration)
# ???????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????

class PublicNewRegistrationCreateView(generics.CreateAPIView):
    """POST /api/student-registration/public/ ??? ?????????? ?????? ?????????? ???????? ???? ????????????"""
    permission_classes = [AllowAny]
...
class AdminNewRegistrationDetailView(generics.RetrieveUpdateDestroyAPIView):
    """GET / PATCH / DELETE /api/student-registration/<id>/ ??? ?????????? ?????? ????????"""
    permission_classes = [IsAdminOrManager]
...
# ???????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????
# 11. ???????? ?????????????? (RegistrationCondition)
# ???????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????

class PublicRegistrationConditionsView(generics.ListAPIView):
    """GET /api/registration-conditions/public/ — شروط التسجيل للزوار"""
    permission_classes = [AllowAny]
...
class AdminRegistrationConditionsListCreateView(generics.ListCreateAPIView):
    """GET / POST /api/registration-conditions/ ??? ?????????? ???????? ??????????????"""
    permission_classes = [IsAdminOrManager]
    serializer_class = RegistrationConditionSerializer
...
class AdminRegistrationConditionDetailView(generics.RetrieveUpdateDestroyAPIView):
    """GET / PATCH / DELETE /api/registration-conditions/<id>/ ??? ?????????? ?????? ????????"""
    permission_classes = [IsAdminOrManager]
...
class PublicSupervisorMiniListView(generics.ListAPIView):
    """GET /api/supervisors/public/ — قائمة المشرفات للزوار"""
    permission_classes = [AllowAny]
    pagination_class = None
...
# ???????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????
# 12. ?????????? ?????????? ?????????????????? (Lecture Supervisors)
# ???????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????

class LectureSupervisorListCreateView(generics.ListCreateAPIView):
    """GET /api/lecture-supervisors/ | POST /api/lecture-supervisors/ ??? ???????????? ??????"""
...
class LectureSupervisorMeView(APIView):
    """GET/PATCH /api/lecture-supervisors/me/ ??? ?????????? ???????????? ???????????? ?????????????? ??????????"""
...
class LectureSupervisorToggleActiveView(APIView):
    """POST /api/lecture-supervisors/<id>/toggle-active/ ??? ?????????? ???? ?????????? ???????? ????????"""
    ...
    def post(self, request, pk):
        ...
        return Response({
            "detail": _("???? ?????????? ????????????.") if user.is_active else _("???? ?????????? ????????????."),
