import{f as re,r,a as P,j as e,d as T,U as H,X as B,g as E,P as oe,h as de,i as O,k as q,T as ce,F as xe}from"./index-DLF5FWbA.js";import{f as me}from"./fetchAll-D_xhPORk.js";import{P as X}from"./plus-wj2bD1NC.js";import{C as he,a as pe,b as be}from"./chevrons-right-s_ZuCix6.js";import{S as G}from"./search-CVew5l-O.js";import{E as ge}from"./external-link-BTEfS2zI.js";import{P as J}from"./pen-Dp07j_rT.js";import{T as ue}from"./trash-2-DX72G81N.js";import{C as je}from"./calendar-CCRXzN1r.js";import{P as fe}from"./printer-Fz5EobH4.js";import{F as we}from"./filter-FwyYfPIp.js";const K=["يناير","فبراير","مارس","أبريل","مايو","يونيو","يوليو","أغسطس","سبتمبر","أكتوبر","نوفمبر","ديسمبر"],Q=new Date().getFullYear(),Ne=Array.from({length:6},(s,i)=>Q-i);function ve({supervisor:s,onClose:i,onSaved:h}){const l=!!(s!=null&&s.id),[d,b]=r.useState({name:(s==null?void 0:s.name)||"",phone:(s==null?void 0:s.phone)||"",address:(s==null?void 0:s.address)||"",notes:(s==null?void 0:s.notes)||"",is_active:(s==null?void 0:s.is_active)??!0}),[f,j]=r.useState(!1),[o,g]=r.useState(""),u=a=>{const c=a.target.type==="checkbox"?a.target.checked:a.target.value;g(""),b(N=>({...N,[a.target.name]:c}))},_=async a=>{var c;a.preventDefault(),j(!0);try{l?await P.patch(`/supervisors/${s.id}/`,d):await P.post("/supervisors/",d),h(),i()}catch(N){const C=(c=N.response)==null?void 0:c.data;g(typeof C=="object"?Object.values(C).flat().join(" "):"حدث خطأ.")}finally{j(!1)}};return e.jsx("div",{className:"fixed inset-0 z-50 flex items-center justify-center p-4 bg-dark-900/80 backdrop-blur-sm",children:e.jsxs("div",{className:"glass-card-strong w-full max-w-lg p-6 animate-slide-up",children:[e.jsxs("div",{className:"flex items-center justify-between mb-5",children:[e.jsxs("h2",{className:"font-cairo font-bold text-white text-lg flex items-center gap-2",children:[l?e.jsx(J,{size:18,className:"text-brand-blue"}):e.jsx(X,{size:18,className:"text-brand-blue"}),l?"تعديل بيانات المشرفة":"مشرفة جديدة"]}),e.jsx("button",{onClick:i,className:"btn-ghost p-1.5",children:e.jsx(B,{size:18})})]}),e.jsxs("form",{onSubmit:_,className:"space-y-4",children:[e.jsxs("div",{className:"grid sm:grid-cols-2 gap-4",children:[e.jsxs("div",{children:[e.jsx("label",{className:"text-white/50 text-xs mb-1 block",children:"الاسم الكامل *"}),e.jsx("input",{name:"name",value:d.name,onChange:u,required:!0,placeholder:"اسم المشرفة",className:"input-glass"})]}),e.jsxs("div",{children:[e.jsx("label",{className:"text-white/50 text-xs mb-1 block",children:"رقم الهاتف"}),e.jsx("input",{name:"phone",value:d.phone,onChange:u,placeholder:"+249...",className:"input-glass",dir:"ltr"})]})]}),e.jsxs("div",{children:[e.jsx("label",{className:"text-white/50 text-xs mb-1 block",children:"السكن / العنوان"}),e.jsx("input",{name:"address",value:d.address,onChange:u,placeholder:"المدينة / الحي",className:"input-glass"})]}),e.jsxs("div",{children:[e.jsx("label",{className:"text-white/50 text-xs mb-1 block",children:"ملاحظات"}),e.jsx("textarea",{name:"notes",value:d.notes,onChange:u,rows:2,placeholder:"ملاحظات اختيارية...",className:"input-glass resize-none"})]}),e.jsxs("label",{className:"flex items-center gap-2 cursor-pointer",children:[e.jsx("input",{name:"is_active",type:"checkbox",checked:d.is_active,onChange:u,className:"w-4 h-4 accent-brand-blue"}),e.jsx("span",{className:"text-white/60 text-sm",children:"مشرفة نشطة"})]}),o&&e.jsx("p",{className:"text-brand-red text-xs bg-brand-red/10 rounded-xl p-3",children:o}),e.jsxs("div",{className:"flex gap-3 pt-1",children:[e.jsxs("button",{type:"submit",disabled:f,className:"btn-primary flex-1 justify-center",children:[f?e.jsx(E,{size:16,className:"animate-spin"}):null,f?"جاري الحفظ...":"حفظ"]}),e.jsx("button",{type:"button",onClick:i,className:"btn-secondary px-6",children:"إلغاء"})]})]})]})})}function ye(s,i,h){const l=new Date().toLocaleDateString("ar-SA",{year:"numeric",month:"long",day:"numeric"}),d=i.length>0?`<div class="summary-box">
