...
</html>`,b=window.open("","_blank","width=900,height=700");if(!b){alert("يرجى السماح بالنوافذ المنبثقة لهذا الموقع لطباعة التقرير.");return}b.document.open(),b.document.write(f),b.document.close()}function pe(){const{id:t}=q(),r=B(),[a,d]=p.useState(null),[x,v]=p.useState(!0),[f,b]=p.useState(null),[o,u]=p.useState(!1),[l,j]=p.useState(!1),[c,y]=p.useState(1),[g,E]=p.useState(20),[$,D]=p.useState({total:0,total_pages:1}),[n,M]=p.useState({filterType:"all",year:String(A),month:"",day:"",dateFrom:"",dateTo:""});p.useEffect(()=>{v(!0),C.get(`/supervisors/${t}/`).then(({data:s})=>d(s)).catch(()=>r("/np-panel/supervisors",{replace:!0})).finally(()=>v(!1))},[t]);const S=(s,m=c,z=g)=>{const h={page:m,page_size:z};return s.filterType!=="all"&&(h.filter_type=s.filterType),(s.filterType==="yearly"||s.filterType==="monthly")&&(s.year&&(h.year=s.year),s.month&&(h.month=s.month)),s.filterType==="day"&&s.day&&(h.day=s.day),s.filterType==="range"&&(s.dateFrom&&(h.date_from=s.dateFrom),s.dateTo&&(h.date_to=s.dateTo)),h},k=p.useCallback((s=n,m=c,z=g)=>{u(!0),C.get(`/supervisors/${t}/report/`,{params:S(s,m,z)}).then(({data:h})=>{b(h),D({total:h.total,total_pages:h.total_pages})}).catch(()=>alert("تعذّر تحميل التقرير.")).finally(()=>u(!1))},[t,n,c,g]);p.useEffect(()=>{t&&k(n,1,g)},[t]),p.useEffect(()=>{f!==null&&k(n,c,g)},[c]);const P=()=>n.filterType==="yearly"?`السنة ${n.year||"الكاملة"}`:n.filterType==="monthly"?`${n.month?L[Number(n.month)-1]:"كل الشهور"} ${n.year||""}`:n.filterType==="day"?n.day?`يوم ${n.day}`:"يوم محدد":n.filterType==="range"?`${n.dateFrom||"—"} إلى ${n.dateTo||"—"}`:"جميع الفترات",U=()=>{j(!0);const s=S(n,1,1e4);s.page_size=1e4,s.page=1,C.get(`/supervisors/${t}/report/`,{params:s}).then(({data:m})=>{de(a,m.students||[],P())}).catch(()=>alert("تعذّر تحميل بيانات الطباعة.")).finally(()=>j(!1))};if(x)return e.jsx("div",{className:"flex-1 flex items-center justify-center min-h-64",children:e.jsx(_,{size:30,className:"animate-spin text-brand-blue"})});const T=(f==null?void 0:f.students)||[],Y=()=>{const{total:s,total_pages:m}=$;if(m<=1)return null;const h=(c-1)*g+1,O=Math.min(c*g,s);return e.jsxs("div",{className:"flex flex-col sm:flex-row items-center justify-between gap-3 px-5 py-3 border-t border-white/08",children:[e.jsxs("p",{className:"text-white/40 text-xs",children:["عرض ",e.jsxs("span",{className:"text-white",children:[h,"–",O]})," من ",e.jsx("span",{className:"text-brand-blue font-semibold",children:s})," طالب"]}),e.jsxs("div",{className:"flex items-center gap-1",children:[e.jsx("button",{disabled:c===1,onClick:()=>y(1),className:"btn-ghost p-1.5 disabled:opacity-30",title:"الأولى",children:e.jsx(se,{size:15})}),e.jsx("button",{disabled:c===1,onClick:()=>y(i=>i-1),className:"btn-ghost p-1.5 disabled:opacity-30",title:"السابق",children:e.jsx(V,{size:15})}),Array.from({length:m},(i,w)=>w+1).filter(i=>i===1||i===m||Math.abs(i-c)<=1).reduce((i,w,R,W)=>(R>0&&W[R-1]!==w-1&&i.push("..."),i.push(w),i),[]).map((i,w)=>i==="..."?e.jsx("span",{className:"text-white/30 text-xs px-1",children:"…"},w):e.jsx("button",{onClick:()=>y(i),className:`w-7 h-7 rounded-lg text-xs font-medium transition-all ${i===c?"bg-brand-blue text-white":"text-white/50 hover:bg-white/10 hover:text-white"}`,children:i},w)),e.jsx("button",{disabled:c===m,onClick:()=>y(i=>i+1),className:"btn-ghost p-1.5 disabled:opacity-30",title:"التالي",children:e.jsx(X,{size:15})}),e.jsx("button",{disabled:c===m,onClick:()=>y(m),className:"btn-ghost p-1.5 disabled:opacity-30",title:"الأخيرة",children:e.jsx(ae,{size:15})})]}),e.jsx("select",{value:g,onChange:i=>{E(Number(i.target.value)),y(1)},className:"input-glass text-xs py-1.5 px-3 w-auto",children:[10,20,50,100].map(i=>e.jsxs("option",{value:i,children:[i," بالصفحة"]},i))})]})};return e.jsxs("div",{className:"space-y-6 animate-fade-in",children:[e.jsxs("div",{className:"flex items-start justify-between flex-wrap gap-3",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("button",{onClick:()=>r("/np-panel/supervisors"),className:"btn-ghost p-2 text-white/50 hover:text-white",title:"العودة",children:e.jsx(G,{size:18})}),e.jsxs("div",{children:[e.jsxs("h1",{className:"font-cairo font-bold text-white text-xl flex items-center gap-2",children:[e.jsx(H,{size:20,className:"text-brand-blue"}),a==null?void 0:a.name]}),e.jsx("p",{className:"text-white/40 text-sm mt-0.5",children:"ملف وتقارير المشرفة"})]})]}),e.jsx("div",{className:"flex gap-2",children:e.jsxs("button",{onClick:U,disabled:!f||o||l,className:"btn-secondary flex items-center gap-2",children:[l?e.jsx(_,{size:15,className:"animate-spin"}):e.jsx(ee,{size:15}),l?"جاري التحضير...":"طباعة التقرير"]})})]}),e.jsxs("div",{className:"glass-card p-5",children:[e.jsxs("div",{className:"grid grid-cols-2 md:grid-cols-4 gap-4 text-sm",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(I,{size:14,className:"text-brand-blue shrink-0"}),e.jsxs("div",{children:[e.jsx("div",{className:"text-white/40 text-xs",children:"الهاتف"}),e.jsx("div",{className:"text-white",dir:"ltr",children:(a==null?void 0:a.phone)||"—"})]})]}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(J,{size:14,className:"text-brand-blue shrink-0"}),e.jsxs("div",{children:[e.jsx("div",{className:"text-white/40 text-xs",children:"العنوان"}),e.jsx("div",{className:"text-white",children:(a==null?void 0:a.address)||"—"})]})]}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(K,{size:14,className:"text-neon-cyan shrink-0"}),e.jsxs("div",{children:[e.jsx("div",{className:"text-white/40 text-xs",children:"إجمالي الطلاب"}),e.jsx("div",{className:"text-neon-cyan font-bold text-lg",children:(a==null?void 0:a.student_count)??"—"})]})]}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(te,{size:14,className:"text-brand-blue shrink-0"}),e.jsxs("div",{children:[e.jsx("div",{className:"text-white/40 text-xs",children:"نتائج التقرير"}),e.jsx("div",{className:"text-white font-bold text-lg",children:o?"...":$.total})]})]})]}),(a==null?void 0:a.notes)&&e.jsx("div",{className:"mt-4 pt-4 border-t border-white/05 text-white/50 text-sm",children:a.notes})]}),e.jsxs("div",{children:[e.jsxs("h2",{className:"font-cairo font-bold text-white text-base flex items-center gap-2 mb-4",children:[e.jsx(F,{size:16,className:"text-brand-blue"}),"تقارير الطلاب"]}),e.jsxs("div",{className:"grid lg:grid-cols-[280px_1fr] gap-5 items-start",children:[e.jsx(ne,{filters:n,onChange:M,onApply:()=>{y(1),k(n,1,g)},loading:o}),e.jsxs("div",{className:"glass-card overflow-hidden",children:[e.jsxs("div",{className:"flex items-center justify-between px-5 py-4 border-b border-white/08",children:[e.jsxs("div",{children:[e.jsx("p",{className:"text-white font-semibold text-sm",children:P()}),e.jsx("p",{className:"text-white/40 text-xs mt-0.5",children:o?"جاري التحميل...":`${$.total} طالب • صفحة ${c} من ${$.total_pages}`})]}),!o&&T.length>0&&e.jsxs("div",{className:"flex items-center gap-1.5 text-xs text-white/40",children:[e.jsx(Q,{size:12,className:"text-neon-cyan"}),e.jsx("span",{className:"text-neon-cyan font-medium",children:T.length})," سجل"]})]}),e.jsx(re,{students:T,loading:o,offset:(c-1)*g}),e.jsx(Y,{})]})]})]})]})}export{pe as default};
